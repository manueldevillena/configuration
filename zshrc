...
export ZSH="/home/villena/.oh-my-zsh"
...
compile_markdown () {
    pandoc $1 -o ${1%.*}.pdf --pdf-engine=pdflatex --indented-code-classes=javascript --highlight-style=monochrome -V mainfont="Palatino" -V documentclass=report -V papersize=A4 -V geometry:margin=1in
}
